...
const en: TranslationMessages = {
  ...
  dailyReport: {
    ...
    empty: {
      ...
      description:
        'Enable scheduled digests, or generate one now from the latest 24 hours of subscriptions.',
    },
    detail: {
      select: 'Select a digest from the list',
      articleCount: '{count} articles',
      noContent: 'There were no matching new articles in this period.',
    ...
    delete: {
      title: 'Delete digest',
      message: 'Delete “{title}”? This will not delete any RSS articles.',
    },
    missed: {
      title: 'Missed digest runs found',
      description:
    ...
    notification: {
      authorized: 'System notifications are authorized',
      denied: 'System notification permission was denied',
      not_determined: 'System notification permission was not granted',
      unsupported: 'System notifications are unavailable in this mode',
    },
    consent: {
      title: 'Authorize cloud AI processing for digests',
      explicitTitle: 'Your explicit consent is required to continue',
      explicitDescription:
        'MRSS stores your data locally by default. The operation below sends some subscription content to your configured third-party AI service. Review and accept the disclosure before continuing.',
      profile: 'AI profile actually used',
      endpoint: 'Redacted service endpoint',
      unknownDestination: 'Unknown AI service',
      sentContentTitle: 'Content that will be sent',
      sentContent:
        'Article titles, RSS summaries, and article content already cached locally by MRSS for the selected period. MRSS does not open source webpages for the digest and does not send API keys or custom authorization data.',
      automationTitle: 'Automatic processing',
      automation:
        'When scheduled digests are enabled, MRSS refreshes feeds and submits the current period to this AI service at the configured time without asking again for every run.',
      costTitle: 'Token charges may apply',
      cost: 'Your AI provider charges the account and model according to its current pricing. MRSS cannot verify the actual price on the provider’s behalf.',
      retentionTitle: 'Third-party retention risk',
      retention:
        'After data leaves this device, it may be handled under the provider’s privacy, logging, and retention policies. Confirm that the service is appropriate for your content before granting access.',
      acknowledge:
        'I have read and agree to send the described content to the displayed AI service, and I understand the automatic processing, token charges, and third-party data retention risks.',
      grantAndContinue: 'Agree and continue',
      grantedToast: 'Cloud AI processing consent saved',
      grantFailed: 'Failed to save cloud processing consent',
      localOnly: 'Local processing only',
      localOnlyDescription:
        'There is no external AI destination. Digests use local processing and do not require cloud processing consent.',
      authorized: 'Cloud processing authorized',
      ...
      revokeConfirm:
        'Scheduled digests will pause, and manual generation or AI outline optimization cannot use the current cloud service until you explicitly authorize it again. Continue?',
      revokedToast: 'Cloud processing consent revoked; scheduled digests are paused',
      revokeFailed: 'Failed to revoke cloud processing consent',
    },
    config: {
      title: 'Digest settings',
      enable: 'Enable scheduled digests',
      enableDescription:
        'Generate a digest each day using local time and adjacent schedule boundaries.',
      ...
      titleTemplateInvalid: 'The title template contains an unknown variable or unmatched brace',
      feeds: 'Feed scope',
      feedsDescription: 'Include all feeds by default, or select specific subscriptions.',
      allFeeds: 'All feeds',
      selectedFeeds: 'Selected feeds',
      searchFeeds: 'Search names, URLs, or categories…',
      selectVisible: 'Select visible',
      uncategorized: 'Uncategorized',
      selectFeedRequired: 'Select at least one feed',
      feedSelectionExpired:
        'All previously selected feeds are unavailable, so scheduled digests were paused. Select feeds again to re-enable them.',
      includeHidden: 'Include hidden articles',
      includeHiddenDescription: 'Hidden articles are excluded from digests by default.',
      focusAndOutline: 'Focus and outline',
      focusDescription: 'Describe what matters to you, then create or arrange 1–12 sections.',
      focusPlaceholder:
        'For example: Prioritize AI products, developer tools, and privacy; reduce marketing news…',
      ...
      sectionInstruction: 'Topics and writing instructions for this section',
      addSection: 'Add section',
      defaultSectionTitle: 'Key highlights',
      defaultSectionInstruction:
        'Summarize the most important information from this period and cite the sources.',
      outlineCountError: 'The outline must contain 1–12 sections',
      outlineInvalid: 'Enter every section title and keep instructions under 500 characters',
      notifications: 'Notifications',
      inAppNotification: 'Show an in-app notification when complete',
      systemNotification: 'Send a system notification when complete',
      notifyOnEmpty: 'Notify when there is no new content',
    },
    toast: {
      loadFailed: 'Failed to load digests. Please try again.',
      detailFailed: 'Failed to load digest details',
      previewFailed: 'Could not preview this digest',
      ...
      configSaveFailed: 'Failed to save digest settings',
      configPausedForConsent:
        'Settings were saved, but scheduled digests remain paused until cloud processing is authorized',
      optimizeFailed: 'Failed to create an outline draft',
      notificationFailed: 'Failed to request notification permission',
      readStateFailed: 'Failed to update read state',
      systemNotificationFallback:
        'The system notification was not delivered; the digest is ready in MRSS',
      missedSkipped: 'Missed digest periods skipped',
      backfillStarted: 'Digest backfill started',
      missedFailed: 'Failed to handle missed digests',
      completed: 'Digest generation completed',
    },
  },
  shortcut: {
    category: {
