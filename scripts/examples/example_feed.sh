#!/bin/bash
#
# Example script for MRSS - Shell RSS Feed Generator
#
...
<rss version="2.0">
  <channel>
    ...
    <link>https://github.com/marcomarcogd/MRSS</link>
    <description>An example feed generated by a shell script</description>
    <lastBuildDate>${CURRENT_DATE}</lastBuildDate>
    <item>
      <title>Welcome to MRSS Custom Scripts</title>
      <link>https://github.com/marcomarcogd/MRSS</link>
    ...
    <item>
      ...
      <link>https://github.com/marcomarcogd/MRSS/blob/main/docs/CUSTOM_SCRIPTS.md</link>
