#!/usr/bin/env node
/**
 * Example script for MRSS - Node.js RSS Feed Generator
 *
 * This script demonstrates how to create a custom RSS feed script using Node.js.
 * Place this file in the MRSS scripts directory and select it when adding a new feed.
 *
...
function generateRss() {
  ...
  const items = [
    {
      title: 'Welcome to MRSS Custom Scripts',
      link: 'https://github.com/marcomarcogd/MRSS',
      description: 'This is an example article generated by a custom Node.js script.',
      pubDate: currentDate
    },
    {
      title: 'How to Create Custom Feed Scripts',
      link: 'https://github.com/marcomarcogd/MRSS/blob/main/docs/CUSTOM_SCRIPTS.md',
  ...
  console.log('    <link>https://github.com/marcomarcogd/MRSS</link>');
