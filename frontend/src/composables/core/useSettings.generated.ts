...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    translation_mode: settingsDefaults.translation_mode,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    miniflux_auto_sync_interval:
      parseInt(data.miniflux_auto_sync_interval) || settingsDefaults.miniflux_auto_sync_interval,
    miniflux_enabled: data.miniflux_enabled === 'true',
    miniflux_last_sync_time:
      data.miniflux_last_sync_time || settingsDefaults.miniflux_last_sync_time,
    ...
    translation_mode: data.translation_mode || settingsDefaults.translation_mode,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_chat_save_history: (
      settingsRef.value.ai_chat_save_history ?? settingsDefaults.ai_chat_save_history
    ).toString(),
    ...
    article_table_columns:
      settingsRef.value.article_table_columns ?? settingsDefaults.article_table_columns,
    article_toolbar_layout:
      settingsRef.value.article_toolbar_layout ?? settingsDefaults.article_toolbar_layout,
    auto_cleanup_enabled: (
      settingsRef.value.auto_cleanup_enabled ?? settingsDefaults.auto_cleanup_enabled
    ).toString(),
    auto_mark_read_days: (
      settingsRef.value.auto_mark_read_days ?? settingsDefaults.auto_mark_read_days
    ).toString(),
    auto_mark_read_enabled: (
      settingsRef.value.auto_mark_read_enabled ?? settingsDefaults.auto_mark_read_enabled
    ).toString(),
    ...
    miniflux_api_password:
      settingsRef.value.miniflux_api_password ?? settingsDefaults.miniflux_api_password,
    miniflux_auto_sync_interval: (
      settingsRef.value.miniflux_auto_sync_interval ?? settingsDefaults.miniflux_auto_sync_interval
    ).toString(),
    miniflux_enabled: (
      settingsRef.value.miniflux_enabled ?? settingsDefaults.miniflux_enabled
    ).toString(),
    miniflux_last_sync_time:
      settingsRef.value.miniflux_last_sync_time ?? settingsDefaults.miniflux_last_sync_time,
    miniflux_server_url:
      settingsRef.value.miniflux_server_url ?? settingsDefaults.miniflux_server_url,
    miniflux_sync_on_startup: (
      settingsRef.value.miniflux_sync_on_startup ?? settingsDefaults.miniflux_sync_on_startup
    ).toString(),
    ...
    scroll_mark_as_read: (
      settingsRef.value.scroll_mark_as_read ?? settingsDefaults.scroll_mark_as_read
    ).toString(),
    ...
    show_unread_counts: (
      settingsRef.value.show_unread_counts ?? settingsDefaults.show_unread_counts
    ).toString(),
    ...
    siyuan_enabled: (
      settingsRef.value.siyuan_enabled ?? settingsDefaults.siyuan_enabled
    ).toString(),
    ...
    startup_minimized: (
      settingsRef.value.startup_minimized ?? settingsDefaults.startup_minimized
    ).toString(),
    startup_on_boot: (
    ...
    translation_mode: settingsRef.value.translation_mode ?? settingsDefaults.translation_mode,
