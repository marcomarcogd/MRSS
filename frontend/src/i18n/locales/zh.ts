...
const zh: TranslationMessages = {
  ...
  aiErrors: {
    ...
    usage_limit_reached: '已达到 MRSS 设置的 AI 使用上限，请调整上限后重试。',
  ...
  setting: {
    about: {
      forkNotice: 'MRSS 是基于 DevXDojo/MrRSS 修改的非官方复刻版。',
  ...
  dailyReport: {
    ...
    action: {
      ...
      markRead: '标为已读',
      markUnread: '标为未读',
      resumeAI: '从断点继续 AI 生成',
      restartAI: '从头重新生成 AI 日报',
      useLocalFallback: '改用本地摘要',
    },
    header: {
      generating: '正在生成 · {progress}%',
      nextRun: '下次生成：{time}',
      notScheduled: '尚未启用定时日报',
    },
    filter: { label: '日报状态', all: '全部状态' },
    mode: { local: '本地摘要' },
    status: {
      queued: '排队中',
      refreshing: '刷新订阅中',
    ...
    progress: {
      ...
      stages: {
        ...
        generating: '正在准备 AI 生成任务…',
        extracting: '正在提取第 {current}/{total} 批文章要点…',
        merging: '正在进行第 {round} 轮合并，第 {current}/{total} 批…',
        finalizing: '正在生成最终栏目内容…',
        saving: '正在保存日报、来源和用量信息…',
        completed: '内容生成完成，正在整理保存…',
      },
    },
    empty: {
      title: '还没有日报',
      description: '启用定时日报，或点击“立即生成”汇总最近 24 小时的订阅内容。',
    },
    detail: {
      select: '从左侧选择一份日报',
      articleCount: '{count} 篇文章',
      noContent: '这个周期没有符合条件的新文章。',
      sourceUnavailable: '来源不可用',
      contentUnavailable: '暂无可显示的结构化内容。',
      sources: '来源',
      lateArrival: '延迟收录',
      partialError: '本期部分数据刷新失败，报告已使用本地现有内容完成。',
      localFallbackUsageLimit: '首次 AI 请求前已达到用量上限，本期已明确使用本地摘要生成。',
      localFallbackNoProvider: '当前没有可用的外部 AI 配置，本期已明确使用本地摘要生成。',
      checkpointInvalidated:
        '文章或日报配置已在断点后发生变化，旧断点不能安全复用。请确认从头重新生成，或改用本地摘要。',
      interruptedError: '日报生成因应用退出而中断，你可以重新生成。',
      failedError:
        'AI 日报生成未完成。已保留成功阶段和实际 Token 用量，你可以继续生成或明确改用本地摘要。',
      failureCode: '错误代码：{code}',
    },
    preview: {
      title: '确认生成日报',
      period: '统计周期',
      ...
      batches: '预计 AI 批次',
      costHint:
        '生成可能调用你配置的 AI 服务并产生 Token 费用。未配置服务或首次请求前已达到限额时使用本地摘要；AI 调用开始后若失败会保留断点，不会自动冒充成功报告。',
      confirm: '开始生成',
    },
    delete: {
      title: '删除日报',
      message: '确定删除“{title}”吗？该操作不会删除任何 RSS 文章。',
    },
    missed: {
      title: '发现未生成的日报',
      description: '应用关闭或休眠期间错过了 {count} 个生成周期。请选择处理方式。',
      closeHint: '关闭此窗口不会写入处理状态，下次启动或进入日报中心仍会提醒。',
      latest: '补最近一期',
      all: '补齐全部',
      skipAll: '全部跳过',
    },
    notification: {
      authorized: '系统通知已授权',
      denied: '系统通知权限已被拒绝',
      not_determined: '尚未取得系统通知权限',
      unsupported: '当前运行模式不支持系统通知',
    },
    consent: {
      title: '授权云端 AI 处理日报内容',
      explicitTitle: '需要你明确授权后才能继续',
      explicitDescription:
        'MRSS 默认在本机保存数据。下面的操作会把部分订阅内容发送到你配置的第三方 AI 服务，请确认你理解并同意。',
      profile: '实际使用的 AI 配置',
      endpoint: '脱敏后的服务地址',
      unknownDestination: '未知 AI 服务',
      sentContentTitle: '将发送哪些内容',
      sentContent:
        '所选周期的文章标题、RSS 摘要和 MRSS 已在本地缓存的正文。不会为了日报打开或抓取原网页，也不会发送 API Key 或自定义鉴权信息。',
      automationTitle: '可能自动执行',
      automation:
        '启用定时日报后，MRSS 会在设定时间自动刷新订阅并向上述 AI 服务提交当期内容，不会每次再次询问。',
      costTitle: '可能产生 Token 费用',
      cost: '调用费用由你的 AI 服务商按照当前账号和模型计费；MRSS 无法代替服务商确认实际价格。',
      retentionTitle: '第三方保留与使用风险',
      retention:
        '数据离开本机后，可能按第三方服务商的隐私政策、日志和数据保留规则处理。请在授权前自行确认该服务是否适合你的内容。',
      acknowledge:
        '我已阅读并同意将上述内容发送到显示的 AI 服务，也理解自动执行、Token 费用及第三方数据保留风险。',
      grantAndContinue: '同意并继续',
      grantedToast: '云端 AI 处理授权已保存',
      grantFailed: '保存云端处理授权失败',
      localOnly: '仅本地处理',
      localOnlyDescription: '当前没有外部 AI 目标，日报使用本地算法生成，不需要云端处理授权。',
      authorized: '已授权云端处理',
      authorizationRequired: '需要重新授权',
      pausedUntilAuthorized:
        '授权已撤销或 AI 配置发生变化，定时日报已暂停；重新授权后才会恢复云端生成。',
      profileChanged: 'AI 配置已更换',
      profileChangedDescription: '保存设置后将自动显示新 AI 配置的授权确认。',
      reviewAndAuthorize: '查看并授权',
      revoke: '撤销授权',
      revokeTitle: '撤销云端处理授权',
      revokeConfirm:
        '撤销后定时日报会暂停，手动生成和 AI 优化目录也无法使用当前云端服务，直到你再次明确授权。确定继续吗？',
      revokedToast: '云端处理授权已撤销，定时日报已暂停',
      revokeFailed: '撤销云端处理授权失败',
    },
    config: {
      title: '日报设置',
      enable: '启用定时日报',
      enableDescription: '每天按本地时间生成前一个计划边界以来的订阅摘要。',
      scheduleTime: '生成时间',
      language: '输出语言',
      followApp: '跟随应用语言',
      chinese: '简体中文',
      ...
      titleTemplate: '标题模板',
      titleVariables: '可用变量：',
      titleTemplateInvalid: '标题模板包含未知变量或未闭合的大括号',
      feeds: '订阅范围',
      feedsDescription: '默认汇总全部订阅，也可以只选择指定订阅。',
      allFeeds: '全部订阅',
      selectedFeeds: '指定订阅',
      searchFeeds: '搜索名称、地址或分类…',
      selectVisible: '全选当前结果',
      uncategorized: '未分类',
      selectFeedRequired: '请至少选择一个订阅源',
      feedSelectionExpired: '此前选择的订阅源已全部失效，定时日报已暂停。请重新选择订阅源后启用。',
      includeHidden: '包含隐藏文章',
      includeHiddenDescription: '默认不在日报中汇总已隐藏的文章。',
      focusAndOutline: '关注重点与目录',
      focusDescription: '告诉 AI 你重点关注的主题，再生成或手动整理 1–12 个栏目。',
      ...
      outlineErrors: {
        ...
        rate_limited: 'AI 服务触发频率限制，请稍后重试。',
        provider_unavailable: 'AI 服务暂时不可用，请稍后重试。',
        authentication_failed: 'AI 服务鉴权失败，请检查所选配置和 API Key。',
      ...
      outlineDraft: 'AI 目录草案（确认后才会应用）',
      useDraft: '使用此草案',
      sectionTitle: '栏目标题',
      sectionInstruction: '该栏目要覆盖的内容与写作要求',
      addSection: '添加栏目',
      defaultSectionTitle: '重点摘要',
      defaultSectionInstruction: '提炼这个周期最重要的信息，并标注来源。',
      outlineCountError: '目录必须包含 1–12 个栏目',
      outlineInvalid: '请填写栏目标题，且每栏要求不能超过 500 字',
      notifications: '提醒',
      inAppNotification: '完成后显示应用内提醒',
      systemNotification: '完成后发送系统通知',
      notifyOnEmpty: '无新内容时也提醒',
    },
    toast: {
      loadFailed: '加载日报失败，请重试',
      detailFailed: '加载日报详情失败',
      previewFailed: '无法预估本次日报',
      generationStarted: '日报已开始生成',
      generationFailed: '启动日报生成失败',
      retryStarted: '已重新开始生成日报',
      resumeStarted: '已从断点继续生成',
      restartStarted: '已从头开始重新生成',
      checkpointChanged: '日报输入已变化，未创建新记录，请从头生成',
      retryFailed: '重试失败',
      localFallbackStarted: '已根据原报告创建本地摘要',
      localFallbackFailed: '创建本地摘要失败',
      deleted: '日报已删除',
      deleteFailed: '删除日报失败',
      configSaved: '日报设置已保存',
      configSaveFailed: '保存日报设置失败',
      configPausedForConsent: '设置已保存，但定时日报会保持暂停，直到你完成云端处理授权',
      optimizeFailed: '生成目录草案失败',
      notificationFailed: '请求系统通知权限失败',
      readStateFailed: '更新已读状态失败',
      systemNotificationFallback: '系统通知未送达，日报已在应用内提醒',
      missedSkipped: '已跳过错过的日报周期',
      backfillStarted: '已开始补生成日报',
      missedFailed: '处理漏跑日报失败',
      completed: '日报生成完成',
    },
  },
  shortcut: {
