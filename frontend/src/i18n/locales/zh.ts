...
const zh: TranslationMessages = {
  ...
  modal: {
    ...
    feed: {
      ...
      xpathConfigInvalid: 'XPath 配置无效，请检查文章选择器和页面结构。',
      editFeed: '编辑订阅',
  ...
  setting: {
    ...
    content: {
      ...
      translationModeManualDesc: '仅在主动操作时翻译整篇文章、标题或指定段落',
    ...
    rule: {
      ...
      invalidBackup: 'MRSS 规则备份格式无效或不受支持，未导入任何规则。',
  ...
  dailyReport: {
    ...
    detail: {
      ...
      checkpointInvalidated: '日报内容或设置已发生变化，请重新生成，或改用本地摘要。',
      interruptedError: '日报生成因应用退出而中断，你可以重新生成。',
      failedError: 'AI 日报生成未完成。你可以继续生成，或改用本地摘要。',
    },
    preview: {
      title: '确认生成日报',
      period: '统计周期',
      ...
      batches: '预计 AI 批次',
      costHint:
        '生成可能调用你配置的 AI 服务并产生 Token 费用。未配置服务或生成前已达到限额时会使用本地摘要；生成失败后可以继续生成或手动改用本地摘要。',
      confirm: '开始生成',
    },
    delete: {
      title: '删除日报',
    ...
    missed: {
      ...
      closeHint: '现在关闭后不会处理这些日报，下次启动或进入日报中心仍会提醒。',
      latest: '补最近一期',
      all: '补齐全部',
      skipAll: '全部跳过',
    },
    ...
    config: {
      ...
      outlineErrors: {
        ...
        provider_rejected_request: 'AI 服务未能生成目录，请尝试其他模型。',
        empty_response: 'AI 服务返回了空内容，请重试或更换模型。',
        invalid_json: 'AI 返回的目录格式无法识别，请重试或更换模型。',
        schema_invalid: 'AI 返回的目录格式不符合要求，请更换模型或手动编辑目录。',
